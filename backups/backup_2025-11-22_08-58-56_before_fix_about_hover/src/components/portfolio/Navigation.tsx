            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="relative flex items-center justify-between h-20">
                    ...
                    >
                        <Button
                            size="sm"
                            className="bg-[#1F2A23] text-white text-sm font-medium px-4 py-2 rounded-lg transition-all duration-0 shadow-sm hover:shadow group flex items-center gap-2"
                        >
                            <motion.div
